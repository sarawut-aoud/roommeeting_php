...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar" style="background-image: linear-gradient(to top, #1a677a,#000000 );">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item">
      <a class="nav-link" href="calendar_admin.php">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    ...
                    <!-- <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="showstatus.php">
                          <i class="fas fa-award"></i>
                          <span><font size="5" face="TH SarabunPSK"><b>ระดับสิทธิ์</b></font></span></a>
                        </li>

                        <li class="nav-item">
                          <a class="nav-link" href="showmember.php">
                            <i class="fas fa-user-alt"></i>
                            <span><font size="5" face="TH SarabunPSK"><b>สมาชิก</b></font></span></a>
                          </li>

                          <li class="nav-item">
                            <a class="nav-link" href="showbooking_admin.php">
                            ...
                            inner join member on event.id = member.id where event.ev_status = '1' group by event.ev_title";
                            ...
                            <li class="nav-item">
                              <a class="nav-link" href="showrequest_admin.php">
                              ...
                              <div id="content">
                                ...
                                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow bg-gradient-info">
                                  ...
                                  <ul class="navbar-nav ml-auto">
                                    ...
                                    <a class="dropdown-item" href="frm_editme.php">
