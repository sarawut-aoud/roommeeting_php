              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  while ($rs=mysqli_fetch_array($query)){
                    ?>
                    <tr>
                      <td height="32" align="center" bgcolor="#F8F8FF"><?php echo "$rs[ro_id]"; ?></td>
                      <td align="center" bgcolor="#F8F8FF"><?php echo "$rs[ro_name]"; ?><?php echo "</a>"; ?></td>
                      <td align="center" bgcolor="#F8F8FF"><?php echo "$rs[ro_people]"; ?><?php echo "</a>"; ?></td>
                      ...
                      <td bgcolor="#F8F8FF"><div align="center">
                        <?php echo "<a href=\"frm_editrooms.php?ro_id=$rs[ro_id]\">"; ?><span  class="btn btn-success   " > <i class="far fa-edit">  แก้ไข </i></a></div></td>
                          <td bgcolor="#F8F8FF"><div align="center">
                           <?php echo "<a href=\"frm_deleterooms.php?ro_id=$rs[ro_id]\">"; ?><span  class="btn btn-danger   " > <i class="fas fa-trash">  ลบ  </i></a></div></td>
                           </tr>
                           <?php
                         }
                         ?>
