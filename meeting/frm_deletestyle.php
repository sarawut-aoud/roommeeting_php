...
if (!$_SESSION['userid']) {
  ...
  <body id="page-top">
   ...
   <tr>
    <br>
    <center>
      <h4 class="text-dark" ><i class="far fa-trash-alt"></i>  ลบข้อมูลรูปแบบห้องประชุม</h4>
    </center>
    <form action="deletestyle.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
      <div class="container text-dark " style="width: 60%; height: auto;">
        <br>
        <tr>
          <th width="143">ชื่อรูปแบบการจัดโต๊ะ :</th>
          <td width="338">
            <input onkeypress="" class="form-control" required name="st_name" type="text" id="st_name" value="<?php echo"$rs[st_name]"; ?>" readonly /></td>
          </tr>
          <br>
          <center>
            <tr>
