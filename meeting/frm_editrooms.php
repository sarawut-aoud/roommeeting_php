...
if (!$_SESSION['userid']) {
  ...
  <body id="page-top">
   ...
   <tr>
    <br>
    <center>
      <h4 class="text-dark" ><i class="far fa-edit"></i>  แก้ไขข้อมูลห้องประชุม</h4>
    </center>
    <form action="editrooms.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                        ...
                        <div class="table-responsive">
                          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">   -->
                            ...
                            <tr>
                              ...
                              <td width="338">
                                <input onkeypress="isInputChar(event)" class="form-control" required name="ro_name" type="text" id="ro_name" value="<?php echo"$rs[ro_name]"; ?>" /></td>
                              </tr>
                              <br>
                              <tr>
                                <th>จำนวนคน :</th>
                                <td>
                                  <input class="form-control" required type="number" name="ro_people" id="ro_people" onkeypress="isInputChar(event)" value="<?php echo"$rs[ro_people]"; ?>"/></td>
                                </tr>
                                <br>
                                <tr>
                                  <th>รายละเอียด :</th>
                                  <td><textarea class="form-control" required name="ro_detail" id="ro_detail"><?php echo"$rs[ro_detail]"; ?></textarea></td>
                                </tr>
                                <br>
                                ...
                                <div class="form-group">
                                  ...
                                  <div>
                                    <input type="color" value="<?php echo"$rs[ro_color]"; ?>" name="ro_color" id="ro_color" class="inputcolor" value="" required />
                                  </div>
                                </div>
