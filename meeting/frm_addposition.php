...
if (!$_SESSION['userid']) {
  ...
  <body id="page-top">
    ...
    <tr>
      <br>
      <center>
        <h4 class="text-dark" ><i class="fas fa-plus"></i>  เพิ่มข้อมูลตำแหน่ง</h4>
      </center>
      <form action="addposition.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"> --> 
                      ...
                      <tr>
                        <th>ชื่อตำแหน่ง :</th>
                        <td>
                          <input class="form-control" placeholder="กรุณาใส่ชื่อตำแหน่ง" required type="text" name="po_name" id="po_name" onkeypress="isInputChar(event)"/></td>
                        </tr>
                        <br>
