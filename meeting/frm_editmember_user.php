...
if (!$_SESSION['userid']) {
  ...
  <body id="page-top">
   ...
   <tr>
    ...
    <form action="editmember_user.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        ...
                                        <tr>
                                          <th>แผนก :</th>
                                          <td><select readonly class="form-control" required="required" name="de_id" id="de_id">
                                            <?php
                                            include ('connect.php');
                                        ...
                                        <tr>
                                          <th>ระดับสิทธิ์ :</th>
                                          <td><select readonly class="form-control" required="required" name="sta_id" id="sta_id">
                                            <?php
                                            include ('connect.php');
