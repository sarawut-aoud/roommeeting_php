...
if (!$_SESSION['userid']) {
  ...
  <body id="page-top">
   ...
   <tr>
    <br>
    <center>
      <h4 class="text-dark" ><i class="fas fa-plus"></i>  เพิ่มข้อมูลอุปกรณ์</h4>
    </center>
    <form action="addequipment.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"> --> 
                      ...
                      <tr>
                        <th>ชื่ออุปกรณ์ :</th>
                        <td>
                          <input class="form-control" placeholder="กรุณาใส่ชื่อแผนก" required type="text" name="eq_name" id="eq_name" onkeypress="isInputChar(event)"/></td>
                        </tr>
                        <br>
                        <tr>
                          <th>แผนกที่ดูแล :</th>
                          <td>
                            <select class="form-control" required="required" name="de_id" id="de_id">
