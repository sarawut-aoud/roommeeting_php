...
if (!$_SESSION['userid']) {
  ...
  <body id="page-top">
   ...
   <div class="col-sm-12">
     <div class="wrap-form">
      <center>
        <h4 class="text-dark" ><i class="fas fa-check-square"></i>  อนุมัติแบบฟอร์มขออนุญาตใช้ห้องประชุม</h4>
      </center>
      <br>
      <form action="requestbooking_user.php" method="post" accept-charset="utf-8">
        ...
        <div class="form-group row">
          ...
          <div class="col-12 col-sm-7">
            <select class="form-control" required="required" name="ev_status" id="ev_status" >
              <option value="0" selected>รออนุมัติจากหัวหน้า</option>
        ...
        <div class="form-group row">
          ...
          <div class="col-12 col-sm-7">
            ...
            autocomplete="off" value="<?php echo $rs['ev_title'];?>" readonly="readonly" required>                
          </div>
        </div>
        <div class="form-group row">
...
<!--       <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-12 col-sm-7">ปี - เดือน - วัน
          <div class="input-group date" id="ev_startdate" data-target-input="nearest">
            ...
            autocomplete="off" value="<?php echo $rs['ev_startdate'];?>" readonly="readonly" required>           
      ...
      <div class="form-group row">
        ...
        <div class="col-12 col-sm-7">ปี - เดือน - วัน
          <div class="input-group date" id="ev_enddate" data-target-input="nearest">
            ...
            autocomplete="off" value="<?php echo $rs['ev_enddate'];?>" readonly="readonly">           
      ...
      <div class="form-group row">
        ...
        <div class="col-12 col-sm-7">ชั่วโมง : นาที
          <div class="input-group date" id="ev_starttime" data-target-input="nearest">
            ...
            autocomplete="off" value="<?php echo $rs['ev_starttime'];?>"readonly="readonly">           
      ...
      <div class="form-group row">
        ...
        <div class="col-12 col-sm-7">ชั่วโมง : นาที
          <div class="input-group date" id="ev_endtime" data-target-input="nearest">
            ...
            autocomplete="off" value="<?php echo $rs['ev_endtime'];?>" readonly="readonly">           
      ...
      <div class="form-group row">
        ...
        <div class="col-12 col-sm-7">
          <input type="text" class="form-control" name="ev_people"
          autocomplete="off" value="<?php echo $rs['ev_people'];?>" readonly="readonly" required>                
        </div>
      </div>
      <div class="form-group row">
        <label for="ro_id" class="col-sm-3 col-form-label text-right text-dark">สถานที่ประชุม :</label>
        <div class="col-12 col-sm-7">
          <select class="form-control" required="required" readonly="readonly" name="ro_id" id="ro_id">
      ...
      <div class="form-group row">
        ...
        <div class="col-12 col-sm-7">
          <select class="form-control" required="required" readonly="readonly"  name="st_id" id="st_id">
