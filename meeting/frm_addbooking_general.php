  ...
  <body id="page-top">
   ...
   <div class="col-sm-12">
     <div class="wrap-form">
      ...
      <br>
      <form action="addbooking_general.php" method="post" accept-charset="utf-8">
        ...
        <div class="form-group row">
          ...
          <div class="col-12 col-sm-7">
            <input type="text" autocomplete="off" class="form-control" placeholder="กรุณากรอกหัวข้อเรื่องประชุม" name="ev_title"
            value="" required>                
          </div>
        </div>
        <div class="form-group row">
