...
if (!$_SESSION['userid']) {
  ...
  <body id="page-top">
   ...
   <tr>
    <br>
    <center>
      <h4 class="text-dark" ><i class="far fa-edit"></i>  แก้ไขข้อมูลตำแหน่ง</h4>
    </center>
    <form action="editposition.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">   -->
                            ...
                            <br>
                            <tr>
                              <th width="143">ชื่อตำแหน่ง :</th>
                              <td width="338">
                                <input onkeypress="isInputChar(event)" class="form-control" required name="po_name" type="text" id="po_name" value="<?php echo"$rs[po_name]"; ?>" /></td>
                              </tr>
                              <br>
