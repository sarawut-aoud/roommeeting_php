...
if (!$_SESSION['userid']) {
  ...
  $sql = "select m.* FROM db_room.member m WHERE m.id = '".$_SESSION['userid']."' ";
  ...
  <body id="page-top">
   ...
   <tr>
    <br>
    <center>
      <h4 class="text-dark" ><i class="far fa-edit"></i>  แก้ไขข้อมูลส่วนตัว</h4>
    </center>
    <form action="editgeneral.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">   -->
                            ...
                            <tr>
                              ...
                              <tr>
                                <th>password :</th>
                                <td width="338">
                                  <input onkeypress="isInputChar(event)" class="form-control" required name="password" type="text" id="password" value="<?php echo $rs['password'];?>" /></td>
                                </tr>
                                <br>
                                <tr>
                                  <th>คำนำหน้า :</th>
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        ...
                                        <tr>
                                          <th>ระดับสิทธิ์ :</th>
                                          <td><select class="form-control" readonly required="required" name="sta_id" id="sta_id">
                                            <?php
                                            include ('connect.php');
                                            $sql1="SELECT s.sta_id ,s.sta_name FROM status s,member m WHERE m.id = '".$_SESSION['userid']."' AND m.sta_id = s.sta_id";
                                            $query1 = mysqli_query($con, $sql1);
                                            while($rs1=mysqli_fetch_array($query1)){
