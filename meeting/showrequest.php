...
if (!$_SESSION['userid']) {
  ...
  $sql = "select event.ev_id, event.ev_title, event.ev_startdate, event.ev_status, event.ev_enddate, event.ev_starttime, event.ev_endtime, event.ev_people, event.ev_createdate, rooms.ro_id, rooms.ro_name, member.id
  from event 
  inner join rooms on event.ro_id = rooms.ro_id
  inner join member on event.id = member.id where event.ev_status = '2' ";
                ...
                <tbody>
                  ...
                  while ($rs=mysqli_fetch_array($query)){
                    ...
                    <tr>
                      ...
                      <td align="left" bgcolor="#F8F8FF" ><?php echo "$rs[ev_status]"; ?></td>
