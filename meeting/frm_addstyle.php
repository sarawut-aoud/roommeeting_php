...
if (!$_SESSION['userid']) {
  ...
  <body id="page-top">
   ...
   <tr>
    <br>
    <center>
      <h4 class="text-dark" ><i class="fas fa-plus"></i>  เพิ่มข้อมูลรูปแบบห้องประชุม</h4>
    </center>
    <form action="addstyle.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"> --> 
                      ...
                      <tr>
                        ...
                        <td>
                          <input class="form-control" placeholder="กรุณาใส่รูปแบบการจัดโต๊ะ" required type="text" name="st_name" id="st_name" onkeypress="isInputChar(event)"/></td>
                        </tr>
                        <br>
                        <center>
                          <tr>
