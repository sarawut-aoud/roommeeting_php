...
<body>
	...
	$sql = "UPDATE event SET ev_title = '$ev_title' , ev_people = '$ev_people', ro_id = '$ro_id', st_id = '$st_id', id = '$id', ev_startdate = '$ev_startdate', ev_enddate = '$ev_enddate', ev_starttime = '$ev_starttime', ev_endtime = '$ev_endtime', ev_status = '$ev_status' WHERE event_id='$event_id'";
