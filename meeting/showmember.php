...
if (!$_SESSION['userid']) {
  ...
  include ('connect.php');
  // $valid_uname = $_SESSION["valid_uname"];
  $sql = "Select * from member as m  Left join department as d on (m.de_id = d.de_id) Left join status as st on (m.sta_id = st.sta_id)"  ;
   ...
   <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><font size="6" face="TH SarabunPSK"> รายงานข้อมูลพนักงาน </font><a href="frm_addmember.php"><span class="btn btn-primary fa fas-plus float-right "><i class="fas fa-plus-circle"> เพิ่มข้อมูลพนักงาน</i></a></h6>
                ...
                while ($rs=mysqli_fetch_array($query)){
                  ...
                  <tr>
                    ...
                    <!-- <td align="center" bgcolor="#F8F8FF"><div align="center">
                     ...
                     <td align="center" bgcolor="#F8F8FF"><div align="center">
                      <?php echo "<a href=\"frm_editmember.php?id=$rs[id]\">"; ?><span  class="btn btn-success   " > <i class="far fa-edit">  แก้ไข </i></span></a></div></td>
                      <td align="center" bgcolor="#F8F8FF"><div align="center">
                       <?php echo "<a href=\"frm_deletemember.php?id=$rs[id]\">"; ?><span  class="btn btn-danger   " > <i class="fas fa-trash">   ลบ   </i></span></a></div></td>
