...
if (!$_SESSION['userid']) {
  ...
  $ev_id = $_GET['ev_id'];
  $sql = "select event.ev_id, event.ev_title, event.ev_startdate, event.ev_enddate, event.ev_starttime, event.ev_endtime, event.ev_people, event.ev_createdate, rooms.ro_id, rooms.ro_name, style.st_id, style.st_name, member.id, member.firstname, member.lastname, department.de_id, department.de_name, department.de_phone
  from event 
  ...
  <body id="page-top">
   ...
   <div class="col-sm-12">
     <div class="wrap-form">
      ...
      <br>
      <form action="editbooking.php" method="post" accept-charset="utf-8">
...
<!--       <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-12 col-sm-7">
          <select class="form-control"readonly required="required"  name="ro_id" id="ro_id">
      ...
      <div class="form-group row">
        ...
        <div class="col-12 col-sm-7">
          <select class="form-control"readonly required="required"  name="st_id" id="st_id">
      ...
      <div class="form-group row">
        ...
        while ($rs=mysqli_fetch_array($query1)){
          $i++;
      $sql2="SELECT eq_id FROM  acces where eq_id='$rs[eq_id]' and ev_id='$ev_id' ";
      $query2 = mysqli_query($con, $sql2);
       $num=mysqli_num_rows($query2);
        ...
        $checkbox = 'checked="checked"';
          ...
          ?>
          <div class="col-12 col-sm-7">
           <input type="checkbox" <?php echo $checkbox ?> name="eqid<?php echo $i ?>" value="<?php echo $rs['eq_id']; ?>"><?php echo "$rs[eq_name]"; ?>
         </div>
         <?php
       }
