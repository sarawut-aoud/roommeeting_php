...
if (!$_SESSION['userid']) {
  ...
  inner join member on event.id = member.id WHERE member.id = '".$_SESSION['userid']."' group by event_id";
    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary"><font size="6" face="TH SarabunPSK"> รายการจองของฉัน </font><a href="frm_addbooking_user.php"><span class="btn btn-primary btn-md  fa fas-plus float-right "><i class="far fa-calendar-check"> จองห้องประชุม</i></a></h6>
                ...
                <tbody>
                  ...
                  while ($rs=mysqli_fetch_array($query)){
                    ...
                    <tr>
                      ...
                      <td align="left" width="320" bgcolor="#F8F8FF"><?php echo "$rs[ev_title]"; ?><?php echo "</a>"; ?></td>
                    ...
                    } else if($rs['ev_status']=='1'){echo "อนุมัติจากหัวหน้า";
          ...
          <td align="center" bgcolor="#F8F8FF"><div align="center">
           ...
           <td align="center" bgcolor="#F8F8FF"><div align="center">
            <?php if($rs['ev_status']!='3') { 
              echo '<a href="frm_editbooking_user.php?ev_id='.$rs['ev_id'].'">';
          ...
          <td align="center" bgcolor="#F8F8FF"><div align="center">
            <?php if($rs['ev_status']!='3') { 
              echo '<a href="frm_deletebooking_user.php?ev_id='.$rs['ev_id'].'">';
