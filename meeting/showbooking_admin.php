...
if (!$_SESSION['userid']) {
  ...
  $sql = "select event.ev_id, event.event_id, event.ev_title, event.ev_startdate, event.ev_enddate, event.ev_starttime, event.ev_endtime, event.ev_status, event.ev_people, event.ev_createdate, rooms.ro_id, rooms.ro_name, member.id
  from event 
  inner join rooms on event.ro_id = rooms.ro_id
  inner join member on event.id = member.id group by event.event_id" ;
  ...
  <head>
    ...
    <title>รายงานการจองทั้งหมด</title>
    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary"><font size="6" face="TH SarabunPSK"> รายงานการจองทั้งหมด </font><a href="frm_addbooking_admin.php"><span class="btn btn-primary btn-md  fa fas-plus float-right "><i class="far fa-calendar-check"> จองห้องประชุม</i></a></h6>
          ...
          <td align="center" bgcolor="#F8F8FF"><div align="center">
           ...
           <td align="center" bgcolor="#F8F8FF"><div align="center">
            <?php if($rs['ev_status']!='3') { 
              echo '<a href="frm_editbooking1_admin.php?ev_id='.$rs['ev_id'].'">';
              echo '<span class="btn btn-success btn-sm " > <i class="far fa-edit">  แก้ไข </i></span></a></div>'; 
            } ?>
          </td>
          
          <td align="center" bgcolor="#F8F8FF"><div align="center">
           <?php echo "<a href=\"frm_deleteallbooking_admin.php?ev_id=$rs[ev_id]\">"; ?><span  class="btn btn-danger btn-sm  " > <i class="fas fa-trash"> ลบ </i></a></div></td>
           </tr>
           <?php
         }
         ?>
