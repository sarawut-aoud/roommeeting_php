...
if (!$_SESSION['userid']) {
  ...
  <body id="page-top">
   ...
   <tr>
    <br>
    <center>
      <h4 class="text-dark" ><i class="far fa-edit"></i>  แก้ไขข้อมูลแผนก</h4>
    </center>
    <form action="editdepartment.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                        ...
                        <div class="table-responsive">
                          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">   -->
                            ...
                            <tr>
                              ...
                              <td width="338">
                                <input onkeypress="isInputChar(event)" class="form-control" required name="de_name" type="text" id="de_name" value="<?php echo"$rs[de_name]"; ?>" /></td>
                              </tr>
                              <br>
                              <tr>
                                <th>เบอร์โทร :</th>
                                <td width="338">
                                  <input onkeypress="isInputChar(event)" class="form-control" required name="de_phone" type="text" id="de_phone" value="<?php echo"$rs[de_phone]"; ?>" /></td>
                                </tr>
                                <br>
