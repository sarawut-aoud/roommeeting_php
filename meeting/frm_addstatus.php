...
<body id="page-top">
  ...
  <tr>
    <br>
    <center>
      <h4 class="text-dark" ><i class="fas fa-plus"></i>  เพิ่มข้อมูลระดับสิทธิ์ในการใช้งาน</h4>
    </center>
    <form action="addstatus.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"> --> 
                      ...
                      <tr>
                        <th>ระดับสิทธิ์ :</th>
                        <td>
                          <input class="form-control" placeholder="กรุณาใส่ระดับสิทธิ์" required type="text" name="sta_name" id="sta_name" onkeypress="isInputChar(event)"/></td>
                        </tr>
                        <br>
