...
<!--       <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        while ($rs1=mysqli_fetch_array($query1)){
          ...
          WHERE event.ev_status = '3' and equipment.eq_id='$rs1[eq_id]' and event.ev_id='$ev_id' and equipment.de_id ='".$_SESSION['de_id']."' and equipment.eq_id = acces.eq_id  group by event.event_id";
