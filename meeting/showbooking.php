...
if (!$_SESSION['userid']) {
  ...
  inner join member on event.id = member.id group by ev_title" ;
                  ...
                  while ($rs=mysqli_fetch_array($query)){
                    ...
                    <tr>
                      ...
                      <td align="center" bgcolor="#F8F8FF"><div align="center">
                       ...
                       <td align="center" bgcolor="#F8F8FF"><div align="center">
                        <?php echo "<a href=\"frm_editbooking.php?ev_id=$rs[ev_id]\">"; ?><span  class="btn btn-success btn-sm  " > <i class="far fa-edit">  แก้ไข </i></a></div></td>
                          <td align="center" bgcolor="#F8F8FF"><div align="center">
