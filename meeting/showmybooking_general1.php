    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary"><font size="6" face="TH SarabunPSK"> แจ้งเตือนรายการจองของฉัน </font><!-- <a href="frm_addbooking_general.php"><span class="btn btn-primary btn-md  fa fas-plus float-right "><i class="far fa-calendar-check"> จองห้องประชุม</i></a> --></h6>
              ...
              <tbody>
                ...
                while ($rs=mysqli_fetch_array($query)){
                  ...
                  if($ev_id){
                    ...
                    if($total==0){
                      $sql2 = "DELETE FROM seting WHERE ev_id ='$ev_id'";
                      $rs2 =  mysqli_query($con, $sql2) or die(mysqli_error(conn)); 

                      $sql1 ="INSERT INTO seting(id,ev_id,set_status)VALUES ('$_SESSION[userid]','$rs[ev_id]','$rs[ev_status]')";
        ...
        <td align="center" bgcolor="#F8F8FF"><div align="center">
         <?php echo "<a href=\"detailbooking_general.php?ev_id=$rs[ev_id]\">"; ?><span  class="btn btn-info btn-sm " > 
