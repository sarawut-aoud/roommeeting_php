...
if (!$_SESSION['userid']) {
  ...
  <body id="page-top">
   ...
   <tr>
    <br>
    <center>
      <h4 class="text-dark" ><i class="far fa-trash-alt"></i>  ลบข้อมูลตำแหน่ง</h4>
    </center>
    <form action="deleteposition.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                        ...
                        <div class="table-responsive">
                          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">   -->
                            ...
                            <tr>
                              ...
                              <td width="338">
                                <input onkeypress="" class="form-control" required name="po_name" type="text" id="po_name" value="<?php echo"$rs[po_name]"; ?>" readonly /></td>
                              </tr>
                              <br>
